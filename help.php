...
<html>
<head>
<title>LinguaBot Chinese Dictionary - Tips and Features</title>
<meta name="description" content="Some useful tips and information to help make the user experience more pleasant." />
<?php
	//common header data
		...
		<div id="twocols">
			...
			<div id="maincol">
				<div id="simpletext">
					...
					<p>If you have any other questions or comments about this site, please feel free to contact me at: <a href="mailto:admin@linguabot.com">admin@linguabot.com</a>.</p>
				</div>
			</div> <!-- end maincol -->
