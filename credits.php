...
<html>
<head>
<title>LinguaBot Chinese Dictionary - About the dictionary</title>
<meta name="description" content="A bit of information on how all this came together." />
<?php
	//common header data
		...
		<div id="twocols">
			...
			<div id="maincol">
				<div id="simpletext">
					...
					<p>If I have forgotten you, or your contribution to this site, please feel free to contact me any time at: <a href="mailto:admin@linguabot.com">admin@linguabot.com</a>.</p>
				</div>
			</div> <!-- end maincol -->
