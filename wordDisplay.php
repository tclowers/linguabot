...
<html>
<head>
<title>LinguaBot Chinese Dictionary - entry: <?php echo $_GET["wId"]; ?></title>
<meta name="description" content="LinguaBot Chinese Dictionary - definitions and character data for entry: <?php echo $_GET["wId"]; ?>" />
<?php
	//common header data
